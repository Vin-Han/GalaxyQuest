#undef GALAXYQUEST_API
#undef GALAXYQUEST_VTABLE
...
#define UE_PROJECT_NAME GalaxyQuest
...
#define GALAXYQUEST_VTABLE DLLEXPORT_VTABLE
#define GALAXYQUEST_API DLLEXPORT
